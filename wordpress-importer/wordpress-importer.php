...
<?php
	...
	function author_select( $n, $author ) {
		...
		$possible_user = get_user_by( 'login', $author['author_login'] );
		wp_dropdown_users( array( 'name' => "user_map[$n]", 'multi' => true, 'show_option_all' => __( '- Select -', 'wordpress-importer' ), 'selected' => $possible_user->ID ) );
